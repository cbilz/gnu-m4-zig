/// This is `std.Build.Step.ConfigHeader` with the following pull request applied:
/// - https://github.com/ziglang/zig/pull/22794
/// - https://github.com/ziglang/zig/pull/22795
